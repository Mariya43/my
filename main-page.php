...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
							...
							<ul class="gn-menu agile_menu_drop">
								...
								<li class="page">
									<a href="#"><i class="fa fa-files-o" aria-hidden="true"></i> Pages <i class="fa fa-angle-down" aria-hidden="true"></i></a>
									  ...
									  <li class="mini_list_agile"> <a href="login.php"> <i class="fa fa-caret-right" aria-hidden="true"></i> Sign In</a></li>
				...
				<!-- //nav_agile_w3l -->
				<li class="second logo"><h1><a href="main-page.html"><i class="fa fa-graduation-cap" aria-hidden="true"></i><?php  echo $_SESSION['u_n'];  ?> </a></h1></li>
					<li class="second admin-pic">
				       <ul class="top_dp_agile">
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img src="<?php echo $_SESSION['image'] ;?> "alt=""> </span> 
											</div>	
										</a>
