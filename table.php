										...
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">Basic Implementation</h3>
											...
											<tbody>
											 <?php
											 include("config.php");
											 $sql="select * from addprd";
											 $rs=mysqli_query($con,$sql);
											 while($result=mysqli_fetch_array($rs)){
											 ?>

											 <tr>
											 <td><?php echo $result['prd_id']?></td>
											 <td><?php echo $result['prd_name']?></td>
											 <td><?php echo $result['prd_quantity']?></td>
											 <td><?php echo $result['prd_price']?></td>
											 <td><img src="<?php echo $result['prd_img']; ?>" style="height:100px;width:100px;"></td>
											 <td><a href="delete.php?abc=<?php echo $result['prd_id']?>" style="text-decoration:none; color:#000;">
											 <button class="btn btn-success">delete</a></td>
											 <td><a href="update.php?az=<?php echo $result['prd_id']?>" style="text-decoration:none; color:#000;">
