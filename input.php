																							...
																							<div class="form-body">
																									<form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
																										<div class="form-group">
																											...
																											<div class="col-sm-8">
																												<input type="text"
																												name="pdname" class="form-control1" id="focusedinput" placeholder="Enter product ">
																											</div>
																											<div class="col-sm-2">
																										...
																										<div class="form-group">
																											...
																											<div class="col-sm-8">
																												<input type="text" 
																												name="pdprice"class="form-control1" id="focusedinput" placeholder="Enter price">
																											</div>
																										</div>
																										<div class="form-group">
																											<label for="inputPassword" class="col-sm-2 control-label">Product Quantity</label>
																											<div class="col-sm-8">
																												<input type="text" class="form-control1"
																												name="pdquantity" id="focusedinput" placeholder="Enter quantity">
																											</div>
																													<div>																								">
																												<input type="file" class="form-control1" name="file" placeholder="choosefile">
																											</div>
